...
uint8_t numNode2 = '2';                                                     //Change here (3).
int replyNum = 0;
int reTry = 0;
...
void loop()
{
  ...
  strcpy(nodeMessage, "12");                                                //Change here (4).
  ...
  do
  {
    ...
    rf95.send((uint8_t *) nodeMessage, sizeof(nodeMessage));                //Send LoRa Data.
    rf95.waitPacketSent();
